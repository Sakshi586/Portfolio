...
function Footer() {
  ...
  return (
    <Foot ref={element}>
      ...
      >
        &copy; Template created with love by Sakshi Kumari
      </motion.span>
      <motion.div
      ...
      >
        <a href="https://www.instagram.com/swaggy_sakshi_/">
        <BsInstagram />
        </a>
        <a href="https://www.facebook.com/profile.php?id=100022867151027">
        <BsFacebook />       
        </a>
        </motion.div>
    </Foot>
